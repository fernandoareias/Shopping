...
namespace Shopping.Carrinho.API.Migrations
{
    ...
    [Migration("20220721155650_VoucherMap")]
    partial class VoucherMap
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shopping.Carrinho.API.Models.CarrinhoCliente", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Shopping.Carrinho.API.Models.CarrinhoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Shopping.Carrinho.API.Models.CarrinhoCliente", b =>
                {
                    b.OwnsOne("Shopping.Carrinho.API.Models.Voucher", "Voucher", b1 =>
                        {
            ...
            modelBuilder.Entity("Shopping.Carrinho.API.Models.CarrinhoItem", b =>
                {
                    b.HasOne("Shopping.Carrinho.API.Models.CarrinhoCliente", "CarrinhoCliente")
                        .WithMany("Itens")
